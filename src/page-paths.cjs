...
/**
 * CommonJS mirror of src/page-paths.js.
 * Target experiment projects (CommonJS) can require this via:
 *   const { pfp, pcd, pdp, buy, PAGE_PATH_CHOICES, getPagePathPromptChoices } =
 *     require('experiment-e2e-generator/page-paths');
 */
